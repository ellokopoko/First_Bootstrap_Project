<aside class='schedule'>
  <h2>Schedule</h2>
  <p>
    There's a lot happening at our many workshop and talks. Make sure you check out the <a href="schedule.php">full schedule</a> for more information
  </p>
    ...
    <div class='panel panel-default'>
      ...
      <div class='collapse panel-collapse' id='monday' aria-expanded='true'>
        <section class='panel-body'>
          ...
          <p>
            <a class='btn btn-danger btn-small' href='schedule.php#monday'>Monday's Schedule</a>
          </p>
        </section>
      </div>
    </div>
    ...
    <div class='panel panel-default'>
      ...
      <div class='collapse panel-collapse' id='tuesday' aria-expanded='true'>
        <section class='panel-body'>
          ...
          <p>
            <a class='btn btn-danger btn-small' href='schedule.php#tuesday'>Tuesday's Schedule</a>
          </p>
        </section>
      </div>
    </div>
